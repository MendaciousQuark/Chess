...
public class BishopTests
{
  ...
  public void testNonCapture()
  {
    ...
    Move trueMove1 = new Move(board, start, end, bishop, bishop.colour, turn, false, check, false, false);
    ...
    Move trueMove2 = new Move(board, start, end, bishop, bishop.colour, turn, false, check, false, false);
    ...
    Move trueMove3 = new Move(board, start, end, bishop, bishop.colour, turn, false, check, false, false);
    ...
    Move trueMove4 = new Move(board, start, end, bishop, bishop.colour, turn, false, check, false, false);
    ...
    Move trueMove5 = new Move(board, start, end, bishop, bishop.colour, turn, false, check, false, false);
    ...
    Move trueMove6 = new Move(board, start, end, bishop, bishop.colour, turn, false, check, false, false);
    ...
    Move falseMove1 = new Move(board, start, end, bishop, bishop.colour, turn, false, check, false, false);
    ...
    Move falseMove2 = new Move(board, start, end, bishop, bishop.colour, turn, false, check, false, false);
  ...
  public void testCapture()
  {
    ...
    // Create the expected move object for the first move
    Move trueMove1 = new Move(board, start, end, bishop, bishop.colour, turn, true, check, false, false);

    // Set the start and end positions for the second move
    start = bishop.setStart(3, 3);
    end =  bishop.setEnd(1, 5);
    // Create the expected move object for the second move
    Move trueMove2 = new Move(board, start, end, bishop, bishop.colour, turn, true, check, false, false);
